#!/usr/bin/env bash
# This script setups dockerized Redash on CentOS 7 and Ubuntu 18.04.
set -eu
...
create_config() {
    ...
    echo "REDASH_MAIL_SERVER=xxx" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_PORT=xxx" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_USERNAME=xxx" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_PASSWORD=xxx" >> $REDASH_BASE_PATH/env
...
setup_compose() {
    ...
    if [ "${distro}" = "centos7" ]; then
		...
		#TODO: add json parsing for centos7
